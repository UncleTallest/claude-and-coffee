...
### Context for Future
- User (Jerry) runs Claude and Coffee Austin meetup, 106 members
- Teaching continuity concepts to non-technical users
- Tam's system (MuChao conversation) is primary case study
```
...
But: don't load everything by default. Load what's relevant to *this* session.
...
- The guide tells Claude *how* to work with you
- The summary tells Claude *what* you're working on
